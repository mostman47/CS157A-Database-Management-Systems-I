 ...
 * 
 * The data is initially sorted before the model is created. Any updates to the
 * model will cause the items to be inserted in sorted order.
 * 
 * @author <a
 *         href="http://tips4java.wordpress.com/2008/11/11/sorted-combo-box-model/"
 *         >javaTips</a>
 */
